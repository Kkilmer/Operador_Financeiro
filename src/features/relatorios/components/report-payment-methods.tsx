...
import { ReportPaymentMethodRow } from "@/features/relatorios/types/report.types";
import { formatCurrency } from "@/lib/utils/currency";

export function ReportPaymentMethods({ rows }: { rows: ReportPaymentMethodRow[] }) {
  return (
    <SectionCard
      title="Formas de pagamento"
      description="Resumo dos gastos por forma de pagamento no período."
    >
